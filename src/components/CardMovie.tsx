...
const CardMovie = ({ title, vote, image, handleClickMovie }: CardMovieProps) => {

    return (
        <button type='button' className='card__movie_container hover:cursor-pointer hover:-translate-y-2 transition-transform transform duration-500' onClick={handleClickMovie}>
